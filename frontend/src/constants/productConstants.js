...
export const GET_BIDDINGS_REQUEST = 'GET_BIDDINGS_REQUEST'
export const GET_BIDDINGS_SUCCESS = 'GET_BIDDINGS_SUCCESS'
export const GET_BIDDINGS_FAIL = 'GET_BIDDINGS_FAIL'
 
export const DELETE_BIDDING_REQUEST = 'DELETE_BIDDING_REQUEST'
export const DELETE_BIDDING_SUCCESS = 'DELETE_BIDDING_SUCCESS'
export const DELETE_BIDDING_RESET = 'DELETE_BIDDING_RESET'
export const DELETE_BIDDING_FAIL = 'DELETE_BIDDING_FAIL'
